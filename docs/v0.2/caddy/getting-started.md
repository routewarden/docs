# Caddy-Warden: Caddy Security Module (v0.2.4)
...
- [RouteWarden Core Architecture & Anti-Evasion Engine]/v0.2/core/architecture)
- [Response Modes Deep Dive (13 Actions)]/v0.2/core/response-modes)
- [Custom Path Patterns Reference]/v0.2/core/custom-patterns)
