# Getting Started with RouteWarden (v0.2.4)
...
- Explore [System Architecture]/v0.2/guide/architecture) to understand the request inspection pipeline.
- View the complete [Configuration Reference]/v0.2/reference/configuration).
- Check the [Examples & Wiki Cookbook]/v0.2/examples/overview) for production Docker Compose & Kubernetes blueprints.
